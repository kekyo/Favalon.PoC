...
namespace Favalon
{
    public sealed class ObservableParser : IObservable<ParseResult>
    {
        private enum States
        {
            Detect,
        ...
        public IDisposable Subscribe(IObserver<ParseResult> observer)
        {
            throw new NotImplementedException();
        }

        public static ObservableParser Create() =>
            new ObservableParser(TextRange.Create(Range.MaxValue));
        public static ObservableParser Create(TextRange textRange) =>
            new ObservableParser(textRange);
    }
}
