    ...
    public sealed class ApplyTermTest
    {
        ...
        public void Apply1_1()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Type), Implicit("b", Type));
            Assert.AreEqual("(a:? b:?):_", term.StrictReadableString);
        ...
        public void Apply1_2()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Type), Implicit("b", Type), Type);
            Assert.AreEqual("(a:? b:?):?", term.StrictReadableString);
        ...
        public void Apply2_1()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Type), Implicit("b", Implicit("System.Int32", Kind)));
            Assert.AreEqual("(a:? b:System.Int32:*):_", term.StrictReadableString);
        ...
        public void Apply2_2()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Type), Implicit("b", Implicit("System.Int32", Kind)), Type);
            Assert.AreEqual("(a:? b:System.Int32:*):?", term.StrictReadableString);
        ...
        public void Apply3_1()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Lambda(Bound("System.Int32", Kind), Type)), Implicit("b", Type));
            Assert.AreEqual("(a:(System.Int32:* -> ?):_ b:?):_", term.StrictReadableString);
        ...
        public void Apply3_2()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Lambda(Bound("System.Int32", Kind), Unspecified)), Implicit("b", Type), Type);
            Assert.AreEqual("(a:(System.Int32:* -> _):_ b:?):?", term.StrictReadableString);
        ...
        public void Apply3_3()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Lambda(Bound("System.Int32", Kind), Type)), Implicit("b", Type), Type);
            Assert.AreEqual("(a:(System.Int32:* -> ?):_ b:?):?", term.StrictReadableString);
        ...
        public void Apply3_4()
        {
            ...
            */
            ...
            var term = Apply(Implicit("a", Lambda(Bound("System.Int32", Kind), Unspecified)), Implicit("b", Type));
            Assert.AreEqual("(a:(System.Int32:* -> _):_ b:?):_", term.StrictReadableString);
