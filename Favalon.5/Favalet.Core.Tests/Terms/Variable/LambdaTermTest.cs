...
namespace Favalet.Terms.Variable
{
    ...
    [TestFixture]
    public sealed class LambdaTermTest
    {
        [Test]
        public void Lambda1()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a", Type), Free("a", Type));
            Assert.AreEqual("(a:? -> a:?):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'2:* -> a:'2:*):('2:* -> '2:*):(* -> *)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda2()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Free("a", Free("System.Int32")));
            Assert.AreEqual("(a:_ -> a:System.Int32:_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:System.Int32:_ -> a:System.Int32:_):(System.Int32:_ -> System.Int32:_):(_ -> _)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda3()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a", Free("System.Int32")), Free("a"));
            Assert.AreEqual("(a:System.Int32:_ -> a:_):_", term.StrictReadableString);
        ...
        public void Lambda4()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b"), Free("a")));
            Assert.AreEqual("(a:_ -> (b:_ -> a:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'2:_ -> (b:'4:_ -> a:'2:_):('4:_ -> '2:_):(_ -> _)):('2:_ -> ('4:_ -> '2:_):(_ -> _)):(_ -> (_ -> _))", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda5()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b"), Free("b")));
            Assert.AreEqual("(a:_ -> (b:_ -> b:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'2:_ -> (b:'4:_ -> b:'4:_):('4:_ -> '4:_):(_ -> _)):('2:_ -> ('4:_ -> '4:_):(_ -> _)):(_ -> (_ -> _))", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda6()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b"), Free("a", Free("System.Int32"))));
            Assert.AreEqual("(a:_ -> (b:_ -> a:System.Int32:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:System.Int32:_ -> (b:'4:_ -> a:System.Int32:_):('4:_ -> System.Int32:_):(_ -> _)):(System.Int32:_ -> ('4:_ -> System.Int32:_):(_ -> _)):(_ -> (_ -> _))", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda7()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b", Free("System.Int32")), Free("a")));
            Assert.AreEqual("(a:_ -> (b:System.Int32:_ -> a:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'2:_ -> (b:System.Int32:_ -> a:'2:_):(System.Int32:_ -> '2:_):(_ -> _)):('2:_ -> (System.Int32:_ -> '2:_):(_ -> _)):(_ -> (_ -> _))", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda8()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a", Free("System.Int32")), Lambda(Bound("b"), Free("a")));
            Assert.AreEqual("(a:System.Int32:_ -> (b:_ -> a:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:System.Int32:_ -> (b:'3:_ -> a:System.Int32:_):('3:_ -> System.Int32:_):(_ -> _)):(System.Int32:_ -> ('3:_ -> System.Int32:_):(_ -> _)):(_ -> (_ -> _))", inferred.AnnotatedReadableString);
        }
    }
}