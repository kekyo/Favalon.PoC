...
{
    internal sealed class LexerCore
    {
        private enum States
        {
            Idle,
        ...
        public Token? Examine(char inch)
        {
            ...
            while (true)
            {
                ...
                if (state == States.Numeric)
                {
                    ...
                    {
                        var token = new NumericToken(buffer.ToString());
                        buffer.Clear();
                ...
                else if (state == States.Operator)
                {
                    ...
                    {
                        var token = new OperatorToken(buffer.ToString());
                        buffer.Clear();
                ...
                else if (state == States.String)
                {
                    ...
                    {
                        var token = new StringToken(buffer.ToString());
                        buffer.Clear();
                ...
                else
                {
                    ...
                    {
                        var token = new VariableToken(buffer.ToString());
                        buffer.Clear();
