    ...
    public sealed class LambdaTermTest
    {
        ...
        public void Lambda1()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Free("a"));
            Assert.AreEqual("(a:_ -> a:_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'a -> a:'a):('a -> 'a)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda2()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Free("a", Implicit("System.Int32")));
            Assert.AreEqual("(a:_ -> a:System.Int32:_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:System.Int32:'a -> a:System.Int32:'a):(System.Int32:'a -> System.Int32:'a):('a -> 'a)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda3()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a", Implicit("System.Int32")), Free("a"));
        ...
        public void Lambda4()
        {
            ...
            */
            ...
            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'a -> (b:'b -> a:'a):('b -> 'a)):('a -> 'b -> 'a)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda5()
        {
            ...
            */
            ...
            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'a -> (b:'b -> b:'b):('b -> 'b)):('a -> 'b -> 'b)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda6()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b"), Free("a", Implicit("System.Int32"))));
            Assert.AreEqual("(a:_ -> (b:_ -> a:System.Int32:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:System.Int32:'a -> (b:'b -> a:System.Int32:'a):('b -> System.Int32:'a)):(System.Int32:'a -> 'b -> System.Int32:'a)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda7()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a"), Lambda(Bound("b", Implicit("System.Int32")), Free("a")));
            Assert.AreEqual("(a:_ -> (b:System.Int32:_ -> a:_):_):_", term.StrictReadableString);

            var (inferred, errors) = context.Infer(term, Term.Unspecified);
            Assert.AreEqual("(a:'a -> (b:System.Int32:'b -> a:'a):(System.Int32:'b -> 'a)):('a -> System.Int32:'b -> 'a)", inferred.AnnotatedReadableString);
        }
        ...
        public void Lambda8()
        {
            ...
            */
            ...
            var term = Lambda(Bound("a", Implicit("System.Int32")), Lambda(Bound("b"), Free("a")));
